		...
		<div class="container">
								...
								<div class="row">
										<div class="col-lg-12 text-center">
												<div class="form-group">
													<a id = "btn_your_user" class ="btn btn-link" user_id = "<?php echo $user_id;?>"  ><i class="fa fa-user"></i></a>
				...
				<div class ="container">
					<ul class ="nav nav-tabs">
						...
						<li class><a href="#tab_user" role="tab" data-toggle="tab">Usuários</a></li>
					</ul>
				</div>	
				...
				<div class="tab-content">
					...
					<div id ="tab_courses" class="tab-pane active">
						<div class="container-fluid">
							...
							<a id= "btn_add_course" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Curso</i></a><br><br>
					...
					<div id ="tab_team" class="tab-pane">
						<div class="container-fluid">
							...
							<a id= "btn_add_member" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Membro</i></a><br><br>
					...
					<div id ="tab_user" class="tab-pane">
						<div class="container-fluid">
							...
							<a id= "btn_add_user" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Usuário</i></a><br><br>
			...
			<div class ="modal-body">
				<form id="form_course">
					...
					<div class= "form-group text-center">
						<button id="btn_save_course" class =" btn btn-primary" type ="submit" >
		...
		<div class ="modal-content">
			...
			<div class ="modal-body">
				<form id="form_member">
					...
					<div class= "form-group text-center">
						<button id="btn_save_member" class =" btn btn-primary" type ="submit" >
							<i class="fa fa-save">&nbsp;&nbsp;</i>Salvar
						</button>
						<span class="help-block"></span>
					</div>
		...
		<div class ="modal-content">
			...
			<div class ="modal-body">
				<form id="form_user">
					...
					<div class= "form-group text-center">
						<button id="btn_save_user" class =" btn btn-primary" type ="submit" >
							<i class="fa fa-save">&nbsp;&nbsp;</i>Salvar
						</button>
						<span class="help-block"></span>
					</div>
